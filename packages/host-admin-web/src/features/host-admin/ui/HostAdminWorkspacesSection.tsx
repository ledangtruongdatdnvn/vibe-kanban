...
import { formatBytes } from "@host-admin/features/host-admin/model/hostAdminPresentation";
import type {
  ToolMessage,
  Workspace,
  WorkspaceUsageItem,
...
export type HostAdminWorkspacesSectionProps = {
...
export function HostAdminWorkspacesSection({
  workspaces,
  workspacesLoading,
  workspaceMessage,
  ...
  onDeleteWorkspace,
  onRefresh,
}: HostAdminWorkspacesSectionProps) {
  return (
